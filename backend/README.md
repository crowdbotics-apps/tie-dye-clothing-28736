...
## Project Structure
    ...
    ├── tie_dye_clothing_28736  # Django project configurations
...
1. Clone this repo and `cd tie_dye_clothing_28736`
...
2. Clone this repo and `cd tie_dye_clothing_28736`
